"""
Django settings for SocialAnalyticsProject project.
...
SECRET_KEY = 'jnwb)-w_w=dhibt7h&pk1x2san=p3n-e5)hd3*7ab)8w3w56uf'
...
ROOT_URLCONF = 'SocialAnalyticsProject.urls'
...
WSGI_APPLICATION = 'SocialAnalyticsProject.wsgi.application'
